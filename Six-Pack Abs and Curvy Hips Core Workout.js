...
var appPath = "/sdcard/6-Pack Abs & Curvy Hips";
var curMenu = "Home";
var curPage = null;
...
function CreateDrawer()
{
	...
	var img = app.CreateImage( "Img/Six-Pack Abs and Curvy Hips Core Workout.png", 0.15 );
	img.SetMargins( 0.02,0.02,0.02,0.01 );
	layDrawerTop.AddChild( img );
	
	//Add app name to top layout.
	var txtName = app.CreateText( "6-Pack Abs & Curvy Hips",-1,-1,"Bold");
